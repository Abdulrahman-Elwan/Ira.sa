...
let translations = {
  en: {
    ...
    ourServicespp: 'Necessitatibus eius consequatur ex aliquid fuga eum quidem sint consectetur velit',
  ...
  ar: {
    ...
    Services: 'الخدمات',
    contact: 'اتصل بنا',
    full_name: 'شركة الموارد الصناعية العربية',
    ...
    aboutText2: 'تعمل هذه الوحدة كموفر حلول شاملة في قطاع التكنولوجيا في جميع أنحاء المملكة العربية السعودية. وتوفر احبار بديلة عالية الجودة للعلامات التجارية العالمية المعروفة  بالإضافة إلى ذلك، تقدم الوحدة ملحقات الكمبيوتر، اللوازم المكتبية، والقرطاسية، مما يضمن حلولاً موثوقة وصديقة للبيئة للشركات',
    ...
    Clients: 'العملاء',
    ourServices: 'خدماتنا',
    ourServicespp: 'احتياجات عملك بأيدٍ أمينة',
    ...
    serviceDetaPP_2: 'نظرًا لعدم وجود حزم ثابتة، لسنا ملتزمين بتقديم نفس الحل لجميع العملاء. يتيح لك هذا نقل ضغط الأداء إلينا. نحن واثقون من أننا نستطيع العثور على الأشخاص المثاليين لحالتك الفريدة. منذ تأسيس الشركة، بذلنا جهودًا لتوفير جميع أنواع المحترفين الفنيين وموظفي الإدارة حسب الحاجة، والحفاظ على تحديث القوى العاملة من حيث التدريب المهني والمهارات التجارية.',
    ...
    Divisions_p3: 'نحن موردون معتمدون لطابعات والحبر الطباعة البديلة للعديد من العلامات التجارية العالمية. نقدم جميع أنواع خراطيش الحبر للطابعات الرئيسية، ويمكننا أيضًا توفير مستلزمات الكمبيوتر والمستلزمات المكتبية',
